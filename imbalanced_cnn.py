...
for run in range(1,6):
    ...
    x_train,y_train=smt.fit_sample(x_train,y_train.argmax(axis=-1))
    model.fit(x_train, keras.utils.to_categorical(y_train,2), batch_size=batch_size, epochs=num_epochs,validation_data=(x_dev, y_dev), verbose=1)
