...
def load_data():
    x, y, vocabulary, vocabulary_inv_list,train_len,dev_len,test_len = data_helpers.load_data()
...
# Data Preparation
print("Load data...")
x_train, y_train,x_dev,y_dev, x_test, y_test, vocabulary_inv = load_data()
